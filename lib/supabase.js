  ...
  const initializeLocalStorage = () => {
    ...
    if (!localStorage.getItem('mock_profiles')) {
      const defaultProfiles = [
        { id: 'user_admin', name: 'Администратор', avatar: '👑', color: '#f59e0b', email: 'admin@taskboard.local', password: '123456', is_admin: true },
        { id: 'user_1', name: 'Асыл', avatar: '👨‍💻', color: '#7c3aed', email: 'asyl@taskboard.local', password: '123456', is_admin: false },
        { id: 'user_2', name: 'Марат', avatar: '🧑‍💼', color: '#3b82f6', email: 'marat@taskboard.local', password: '123456', is_admin: false },
        { id: 'user_3', name: 'Айгерим', avatar: '👩‍🔬', color: '#ec4899', email: 'aigerim@taskboard.local', password: '123456', is_admin: false }
      ];
